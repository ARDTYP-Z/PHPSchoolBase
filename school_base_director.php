...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="school_base_director.css">

</head>
<body>

<h1>Your level is Director</h1>
<h2 class="h2">Hear you can see information about teachers and students</h2>
...
<h3 class="h3">Teachers: </h3>

<?php
$select = 'SELECT * FROM SCHOOL_INFO.school_registration WHERE level = "Teacher"';
